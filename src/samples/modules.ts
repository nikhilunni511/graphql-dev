...
import { resolvers as asoiafResolver, typeDefs as asoiafTypeDefs} from './asoiaf'
...
export const dataSources = () => {
    for (let i = 0; i < moduleNames.length; i++) {
        dataSourceObj = {[moduleNames[i]]:new datasourcesFromModules[moduleNames[i]](),...dataSourceObj}
    }
